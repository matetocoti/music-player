...
const PlayerHeader = ({ title, artist }: PlayerHeaderProps) => {
  return (
    <div className="relative w-full b- min-h-0 shrink-0 overflow-hidden border-b border-zinc-200/60 bg-gradient-to-r from-white/35 via-sky-50/35 to-zinc-100/35 px-4 py-3 font-sans dark:border-zinc-700/60 dark:from-zinc-900/35 dark:via-slate-900/35 dark:to-zinc-950/35 sm:py-4">
      <div
