    ...
    >
      <div>
        ...
        <div className="flex items-center gap-1.5 text-xs text-zinc-600 sm:gap-2 sm:text-sm dark:text-zinc-400">
          <Disc3 className="h-3.5 w-3.5 shrink-0 text-zinc-400 sm:h-4 sm:w-4 dark:text-zinc-500" aria-hidden="true" />
