  ...
  return (
    ...
    >
      ...
      <div className="mx-auto flex w-full max-w-[1600px] items-center justify-between gap-4 sm:gap-6">
        <Link
          to={homeTo}
          className="group flex min-w-0 pl-4 pr-4 pb-1 items-center gap-3 rounded-2xl outline-none transition-all duration-300 focus-visible:ring-2 focus-visible:ring-emerald-500/40 active:scale-[0.98] sm:gap-5 sm:active:scale-100 sm:active:opacity-80"
        >
          <div className="relative flex h-5 w-5 shrink-0 items-center justify-center rounded-2xl border border-zinc-200/80 bg-gradient-to-br from-white/80 to-zinc-100/50 shadow-sm backdrop-blur-md transition-all duration-500 ease-out group-hover:scale-105 group-hover:shadow-md dark:border-zinc-700/80 dark:from-zinc-800/80 dark:to-zinc-900/50 sm:h-12 sm:w-12 sm:transition-all sm:duration-700 sm:group-hover:scale-[1.03]">
            <div
              className="absolute inset-0 rounded-2xl bg-emerald-500/10 opacity-0 blur-md transition-opacity duration-500 group-hover:opacity-100 dark:bg-emerald-400/10 sm:duration-700"
              aria-hidden="true"
            />
