...
const Modal = ({
  ...
  return (
    <dialog
      ...
      className="modal-backdrop-enter fixed inset-0 z-[100] m-0 flex h-full w-full max-w-none items-center justify-center border-0 bg-zinc-950/60 p-5 backdrop-blur-sm"
    >
      <div className="modal-panel-enter w-full max-w-md rounded-3xl border border-zinc-200/80 bg-white p-5 shadow-2xl dark:border-zinc-700 dark:bg-zinc-900 sm:p-6">
